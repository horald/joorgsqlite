  	 ...
  	 if ($arrelement['fieldsave']<>"NO") {
          if ($arrelement['getdefault']=="true") {
            ...
            if ($rowflt = $resflt->fetchArray()) {
              $sqldef="UPDATE tblfilter SET fldwert='".$_POST[$arrelement['name']]."' WHERE fldmaske='".strtoupper($menu)."_DEFAULT' AND fldName='".$arrelement['name']."'"; 
            } else {
              $sqldef="INSERT INTO tblfilter (fldmaske,fldName,fldwert) VALUES('".strtoupper($menu)."_DEFAULT','".$arrelement['name']."','".$_POST[$arrelement['name']]."')";
            }
            //echo $sqldef."<br>";
